...
\newcommand{\authorText}{T. Bonomelli, P. Günthard an der Berufsbildungsschule Winterthur}
...
\begin{document}
	...
	\lstinputlisting[language=SQL]{prototype/anti_social.sql}
	
	\section{Prototype}
	
	\textbf{index.php}
	
	\lstinputlisting[language=PHP]{prototype/index.php}
	
	\textbf{php/utils/sql\_util.php}
	
	\lstinputlisting[language=PHP]{prototype/php/utils/sql_util.php}
