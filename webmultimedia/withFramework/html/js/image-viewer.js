function initImageViewer() {
    ...
    var imageViewer = {
        ...
        "openFrame": function() {
            ...
            $("#imgvMainLayer").on('touchmove', function(event) {
                console.log(event);
            });
        ...
        "closeFrame": function() {
            try {
                ...
                console.log("remove of frame failed", e);
            }
        },
        "setImg": function(uri) {
        ...
        "nextImg": function() {
            try {
                ...
                setTimeout(function() {
                    $("#imgvImg").animate({
                        "margin-left": ($(window).width() - $("#imgvImg").width()) / 2 + "px"
                    }, 500);
                }, 500);
